...
<section class="relative isolate overflow-hidden bg-white px-6 py-12 sm:py-12 lg:overflow-visible lg:px-0">
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
            <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 ">PostIt's Top posts 
            <br/></h2>
        </div>
             ...
             @endphp 
                ...
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md ">
                    ...
                    <div class="flex justify-between w-12">
                        ...
                        <p>{{ $row['comments_count'] }}</p>
                    </div>

                    <div class="flex justify-between mx-4 w-10">
                        @if($row['liked_by_current_user'])
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center space-x-4">
                            <img class="w-7 h-7 rounded-full" src="{{$row['user']['profile_photo']}}" alt="Jese Leos avatar" />
                            <span class="font-medium ">
                                {{$row['user']['surname']." ".$row['user']['name']}}
                            </span>
                        </div>
                        <a href="/post/{{$row['id']}}" class="inline-flex items-center font-medium text-primary-600  hover:underline">
                            Read more
